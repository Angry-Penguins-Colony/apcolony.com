    ...
    return (
        <div className={styles.itemsSlider}>
            <div className={styles.track}>
                ...
                <AnItem src='/img/items/CGS_Hoodie EGLD Noir_TK01.png' />
                <AnItem src='/img/items/CGS_Mariniere Bleu_TK01.png' />
                <AnItem src='/img/items/CGS_Penguin Joker Vest_TK01.png' />
                <AnItem src='/img/items/CGS_Skin Or_TK02.png ' />
                <AnItem src='/img/items/CGS_Yeux Bleu_TK02.png' />
                <AnItem src='/img/items/CGS_Yeux Serpent_TK02.png' />
                <AnItem src='/img/items/CGS_Chaine BTC Argent_TK01.png' />
            ...
            <div className={styles.track + ' ' + styles.revert}>
                ...
                <AnItem src='/img/items/CGS_Yeux qui pleure_TK01.png' />
                <AnItem src='/img/items/CGS_Submachine gun_TK02.png' />
                <AnItem src='/img/items/CGS_Skin Argent_TK01.png' />
                <AnItem src='/img/items/CGS_Oeil Rouge_TK01.png' />
                <AnItem src='/img/items/CGS_Trident_TK01.png' />
